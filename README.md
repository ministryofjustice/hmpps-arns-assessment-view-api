...
Our security policy is located [here](https://github.com/ministryofjustice/hmpps-arns-assessment-view-api/security/policy).
...
## Renaming from HMPPS Arns Assessment View Api - github Actions
...
```bash
docker compose pull && docker compose up --scale hmpps-arns-assessment-view-api=0
```
